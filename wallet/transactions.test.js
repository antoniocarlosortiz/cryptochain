...
describe('Transaction', () => {
    ...
    describe('input', () => {
        ...
        it('sets the `address` to the sender `senderWallet` publicKey ', () => {
        ...
        describe('when the transaction is invalid', () => {
            describe('and a transaction outputMap value is invalid', () => {
                it('returns false and logs an error', () => {
                    transaction.outputMap[senderWallet.publicKey] = 'random hex'
            ...
            describe('and a transaction input signature is invalid', () => {
                it('returns false', () => {
                    transaction.input.signature = new Wallet().sign('random words')
                    expect(Transaction.validTransaction(transaction)).toBe(false)
                    expect(errorMock).toHaveBeenCalled()
                })
            })
